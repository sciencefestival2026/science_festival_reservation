...
export default function Home() {
  ...
  // 1. 過去枠以外の有効なデータ
  const validMasterData = masterData.filter(
    d => !isPastSlot(d.event_date, d.time_slot)
  );
  ...
  const currentApplied = selectedSlot ? (selectedSlot.capacity - getSlotRemaining(selectedSlot)) : 0;
